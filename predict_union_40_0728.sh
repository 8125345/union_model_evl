...
${PYTHON} tflite_analyser.py \
--input_dir ${OUT_PREDICT_DIR}/bgm_record_20220728_0.01 \
--output_dir ${OUT_ANALYSER_DIR}/bgm_record_20220728_0.01 &&
wait &&

${PYTHON} tflite_analyser.py \
--input_dir ${OUT_PREDICT_DIR}/bgm_record_20220728_0.05 \
--output_dir ${OUT_ANALYSER_DIR}/bgm_record_20220728_0.05 &&
wait &&
